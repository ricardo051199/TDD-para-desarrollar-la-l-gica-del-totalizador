describe("Totalizador ", () => {
  ...
  it("calcular total para un descuento por defecto", () => {
    expect(calcularTotal(2, 2, "AL")).toEqual(4.16);
  });
  ...
  it("calcular total para un descuento de 7%", () => {
    expect(calcularTotal(7000, 2, "AL")).toEqual(13540.8);
  });
  it("calcular total para un descuento de 10%", () => {
    expect(calcularTotal(10000, 2, "AL")).toEqual(18720);
  });
  it("calcular total para un descuento de 15%", () => {
